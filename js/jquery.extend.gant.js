...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            createProgressBar: function (label, desc, classNames, dataObj, finishPer, overduePer) {
                ...
                // 处理完成比，显示为绿色
                if (finishPer) {
                    bar.append('<div class="finish" style="width: ' + finishPer +'"></div>');
                }
            ...
            fillData: function (element, datapanel, leftpanel /* <- never used? */) {
                ...
                var spacerHeight = $('.row.spacer').outerHeight();
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            case "hours":
                                ...
                                _bar = core.createProgressBar(day.label, day.desc, day.customClass, day.dataObj, day.finishPer, day.overduePer);

                                // find row
                                topEl = $(element).find("#rowheader" + i);
                                top = cellWidth * 5 + barOffset + topEl.data("offset");
                                top = leftPanelHeight + spacerHeight - leftRowHeight / 2 - 9;
